...
for PROJECT_CONFIG_FILE in glob("*/video-annotator-prj"):
    ...
    #data['_filter_panel']['value']['_imgfilters']['value'][0][1]['_field_adaptive_threshold_block_size']['value']=649
    data['_filter_panel']['value']['_imgfilters']['value'][0][1]['_field_adaptive_threshold_c']['value']=85


    data['_input']['value']['_panel']['value']['_objects']['selected']=['object-0']
    data['_input']['value']['_panel']['value']['_datasets']['selected']=['body-0']
    ...
    data['_input']['value']['_panel']['value']['_datasets']['selected']=['body-1']
